...
public class AdminListAllUser extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_list_all_user);
        ...
        db.collection("Users")
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        ...
                        //adapter
                        adapter = new CustomAdapter(AdminListAllUser.this,userList,"gestionnaire2");
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        pd.dismiss();
                        Toast.makeText(AdminListAllUser.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
