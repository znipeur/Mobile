...
public class AdminAllParkings extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_all_parkings);
        ...
        db.collection("Documents")
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        ...
                        //adapter
                        adapter = new CustomAdapter(AdminAllParkings.this,modelList,"admin2");
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        pd.dismiss();
                        Toast.makeText(AdminAllParkings.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
